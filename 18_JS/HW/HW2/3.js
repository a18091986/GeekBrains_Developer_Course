...
const dayNumber = Number(prompt("Введите число в интервале от 1 до 31"));

console.log((dayNumber > 0 && dayNumber < 32) ? 
`Число ${dayNumber} попадает в ${Math.trunc(dayNumber / 10 + 1)} декаду месяца` : "Неверное значение");
